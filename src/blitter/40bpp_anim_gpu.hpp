...
/** @file 40bpp_anim_gpu.hpp Optimized 40 bpp blitter. */
...
class FBlitter_40bppAnimGPU : public BlitterFactory {
protected:
	bool IsUsable() const override
	{
		return VideoDriver::GetInstance()->SupportsGPUBlitting() && VideoDriver::GetInstance()->HasAnimBuffer();
	}

public:
	FBlitter_40bppAnimGPU() : BlitterFactory("40bpp-anim-gpu", "40bpp Animation GPU-based Blitter") {}
	Blitter *CreateInstance() override { return new Blitter_40bppAnimGPU(); }
};
